...
adminRoutes.get("/offer",isAuth.isAdminAuth,offerController.loadOffers);

adminRoutes.get('/addOffers',isAuth.isAdminAuth,offerController.loadAddOffers)

adminRoutes.post('/addoffers',isAuth.isAdminAuth,offerController.addOffers)

adminRoutes.post('/applyOffer',isAuth.isAdminAuth,offerController.postApplyOffer);
